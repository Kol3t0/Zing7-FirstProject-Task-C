      ...
      <div className="flex flex-col justify-center w-full max-w-[90%] h-auto mt-[48px] lg:max-w-[1296px] lg:h-[481px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <article className="mb-[16px]">
            <img src="/docking.png" alt="docking" className="w-full h-auto max-w-full cursor-pointer hover:scale-105 transition-transform duration-400 ease-in-out"/>
          ...
          <article className="mb-[16px]">
            <img src="/pushing-cart.png" alt="pushing" className="w-full h-auto max-w-full cursor-pointer hover:scale-105 transition-transform duration-400 ease-in-out"/>
           <p className="text-[18px] text-[#01303A] hover:text-black font-semibold mt-4 leading-[140%] tracking-[-0.5px] 
             cursor-pointer hover:scale-105 transition-transform duration-400 ease-in-out md:text-[24px] text-center">
                Хладилен транспорт
            </p>
          ...
          <article className="mb-[16px]">
            <img src="/containers.png" alt="containers" className="w-full h-auto max-w-full cursor-pointer hover:scale-105 transition-transform duration-400 ease-in-out"/>
            <p className="text-[18px] text-[#01303A] hover:text-black font-semibold mt-4 leading-[140%] tracking-[-0.5px] 
             cursor-pointer hover:scale-105 transition-transform duration-400 ease-in-out md:text-[24px] text-center">
